...
var credentials = document.getElementById('credentials-list');

credentials.innerHTML += '<li>'+resumeData.credentials[0]+'</li>';
credentials.innerHTML += '<li>'+resumeData.credentials[1]+'</li>';
credentials.innerHTML += '<li>'+resumeData.credentials[2]+'</li>';
credentials.innerHTML += '<li>'+resumeData.credentials[3]+'</li>';
